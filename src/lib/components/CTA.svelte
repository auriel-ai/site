  ...
  <div class="max-w-7xl mx-auto">
    ...
    <div class="flex justify-center gap-2 mb-40 flex-wrap">
      <button 
        ...
        class="bg-white border-neutral-300 text-neutral-900 px-6 py-3 rounded-full transition font-regular text-sm focus:outline-none flex items-center gap-2 hover:bg-neutral-50 hover:border-neutral-400">
