...
<div class="bg-[#f7f9f8] min-h-screen pb-20">
  <div class="container mx-auto max-w-3xl px-4 py-8">
    <h1 class="text-3xl md:text-4xl font-bold text-neutral-900 mb-10">Terms of Service</h1>
    ...
    <div class="space-y-10 text-neutral-800 text-base">
      ...
      <section>
        <h2 class="text-xl font-semibold text-neutral-900 mb-4">Use of Our Website</h2>
        <p>
      ...
      <section>
        <h2 class="text-xl font-semibold text-neutral-900 mb-4">Custom Services</h2>
        <p>
      ...
      <section>
        <h2 class="text-xl font-semibold text-neutral-900 mb-4">Intellectual Property</h2>
        <p>
      ...
      <section>
        <h2 class="text-xl font-semibold text-neutral-900 mb-4">Limitation of Liability</h2>
        <p>
      ...
      <section>
        <h2 class="text-xl font-semibold text-neutral-900 mb-4">Changes to Terms</h2>
        <p>
